...
class App extends Component {
  ...
  login() {
    let { REACT_APP_AUTH0_DOMAIN, REACT_APP_CLIENT_ID } = process.env;
    let redirectUri= encodeURIComponent('http://localhost:3001/auth/callback')
    window.location = `https://${REACT_APP_AUTH0_DOMAIN}/authorize?client_id=${REACT_APP_CLIENT_ID}&scope=openid%20profile%20email&redirect_uri=${redirectUri}&response_type=code`;
  }
